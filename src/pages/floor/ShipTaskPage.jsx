      ...
      <div className="flex-1 max-w-md mx-auto w-full px-4 py-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div><p className="text-sm text-gray-500">Ship To</p><p className="text-base font-semibold text-gray-900">123 Main Street, Anytown, USA</p></div>
          </div>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between py-1.5 border-b border-gray-50"><span className="text-gray-500">Item</span><span className="font-medium text-gray-900">{task.sku_name || 'Package'}</span></div>
